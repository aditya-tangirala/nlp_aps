...
//		}
	...
	public static String verbsAddress = "data/verbs3.txt";
	public static String pverbsAddress = "data/pverbs_h1.txt";
	public static String pverbsAddress2 = "data/pverbs_h2.txt";
	...
	public static void setVerbMeans() {
		...
		Scanner sc = null;
		try {
			sc = new Scanner(new File("data/vsim.txt"));
	...
	public static void analyzeQuestions(String[] args) throws FileNotFoundException {
		...
		int allLen = 0;
		if (args == null){
//			sc = new Scanner(new File("data/all_a_refined.txt"));
//			sc = new Scanner(new File("data/prev_a.txt"));
			sc = new Scanner(new File("data/DfN/DS2/q.txt"));
			// Scanner sc = new Scanner(new File("data/ixl_a.txt"));
//			sc2 = new Scanner(new File("data/all_aa_refined.txt"));
			sc2 = new Scanner(new File("data/DfN/DS2/ans.txt"));
//			sc2 = new Scanner(new File("data/prev_aa.txt"));
		}
		else{
			sc = new Scanner(new File(args[0]));
			// Scanner sc = new Scanner(new File("data/data/ixl_a.txt"));
			sc2 = new Scanner(new File(args[1]));
			pverbOffset = Integer.parseInt(args[2]);
		}

		answers = new ArrayList<Double>();
		// Scanner sc2 = new Scanner(new File("data/ixl_aa.txt"));
		while (sc2.hasNext()) {
		...
		int corrCount = 0;
		int corrCount2 = 0;
		PrintStream op = new PrintStream(new File("data/corrects.txt"));
		PrintStream op2 = new PrintStream(new File("data/corrects3.txt"));
		PrintStream opIncorrect = new PrintStream(new File("data/incorrect_11.txt"));
		while (sc.hasNext()) {
...
//				SentenceAnalyzer.println(line);
	...
	public static World[] analyzeQuestionsforGuessLabel(String[] questions,
		...
		isWebAnalyzing = true;
		Scanner sc2 = new Scanner(new File("data/aa.txt"));
		ArrayList<String> questionsArr = new ArrayList<String>();
		if (questions == null) {
			if (fileName == null) {
				fileName = "a.txt";
